...
quizArea.innerHTML = `
    ...
    <div class="question">function mostrarResposta(numero) {
const resposta = document.getElementById("resposta" + numero);
...
if (!quizArea) {
    console.error("Elemento #quiz-area não foi encontrado.");
    return;
}
...
if (pontuacao === 10) {
    ...
    mensagem = "🏆 Excelente! Você acertou todas as perguntas.";

} else if (pontuacao >= 7) {

    mensagem = "🎉 Muito bom! Você demonstrou um bom conhecimento sobre fake news.";
    ...
    mensagem = "📚 Continue estudando! Verificar fontes é muito importante antes de compartilhar informações.";
}
